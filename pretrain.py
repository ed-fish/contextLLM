...
def get_args_parser():
    ...
    # Transformer & Encoder
    parser.add_argument('--mbart_path', type=str, default="/home/ef0036/Projects/contextLLM/pretrain_models/MBart_trimmed",
                        help='Path to the MBart model.')
    parser.add_argument('--tokenizer_path', type=str, default="/home/ef0036/Projects/contextLLM/pretrain_models/MBart_trimmed",
    ...
    # Data / JSON paths
    parser.add_argument('--train_json', type=str, default="/home/ef0036/Projects/contextLLM/data/ytsl/post_proces_1500.json", help='Path to final JSON for train segments.')
    parser.add_argument('--val_json', type=str, default="/home/ef0036/Projects/contextLLM/data/ytsl/post_proces_1500.json", help='Path to final JSON for val segments.')
    parser.add_argument('--test_json', type=str, default="/home/ef0036/Projects/contextLLM/data/ytsl/post_proces_1500.json", help='Path to final JSON for test segments.')
